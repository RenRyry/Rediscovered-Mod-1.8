...
public class EntityGreenVillager extends EntityAgeable implements INpc, IMerchant
{
    ...
    public IEntityLivingData onSpawnFirstTime(DifficultyInstance p_180482_1_, IEntityLivingData p_180482_2_)
    {
    ...
    public EntityGreenVillager func_180488_b(EntityAgeable p_180488_1_)
    {
        ...
        entityvillager.onSpawnFirstTime(this.worldObj.getDifficultyForLocation(new BlockPos(entityvillager)), (IEntityLivingData)null);
